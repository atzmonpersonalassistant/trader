...
Future scanner work should be implemented under the coherent `options-planning-lab/` structure, not as separate top-level radar projects.
...
- `options-planning-lab/data/results/` — scan and backtest output artifacts.
- `options-planning-lab/reports/daily/` — generated daily candidate reports.
- `options-planning-lab/reports/backtests/` — generated backtest reports.
